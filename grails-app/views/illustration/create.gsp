            ...
            <g:form resource="${this.illustration}" method="POST">
                <fieldset class="formu">
                    ...
                    <div class="fieldcontain required">
                        <br><br><br>
                        <g:select class="un" from="${com.mbds.grails.Annonce.list()}"
                                  name="annonce.id" id='annonce.id' optionKey="id" optionValue="title"/>
                        <input type="file"  class ="un" name="filename" value="" required="" id="fileInput" placeholder="Entrez un nom de fichier">
