...
<div id="list-user" class="content scaffold-list" role="main">
    ...
    <table class="t1">
        ...
        <tr >
            ...
            <g:sortableColumn property="Mot de passe" title="Nom de utilisateur" style="text-align:center !important;"/>
        ...
        <g:each var="user" in="${userList}" >
            <tr>
                ...
                <td style="text-align:center !important;">${user.password}</td>
